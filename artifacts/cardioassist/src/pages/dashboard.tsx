...
import { usePredictHeartDisease, useGetModelMetrics, getGetModelMetricsQueryKey } from "@workspace/api-client-react";
...
// Feature contribution label map
...
function FeatureBar({ name, value, max }: { name: string; value: number; max: number }) {
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="text-xs font-medium text-muted-foreground w-32 shrink-0 text-right">{label}</span>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    <FormField control={form.control} name="age" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input type="number" className="rounded-lg" data-testid="input-age" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    ...
                    <FormField control={form.control} name="sex" render={({ field }) => (
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} defaultValue={String(field.value)}>
                          <FormControl>
                            <SelectTrigger className="rounded-lg" data-testid="select-sex"><SelectValue /></SelectTrigger>
                          </FormControl>
                          <SelectContent>
                    ...
                    <FormField control={form.control} name="cp" render={({ field }) => (
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} defaultValue={String(field.value)}>
                          <FormControl>
                            <SelectTrigger className="rounded-lg" data-testid="select-cp"><SelectValue /></SelectTrigger>
                          </FormControl>
                          <SelectContent>
                    ...
                    <FormField control={form.control} name="trtbps" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input type="number" className="rounded-lg" data-testid="input-trtbps" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    ...
                    <FormField control={form.control} name="chol" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input type="number" className="rounded-lg" data-testid="input-chol" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    ...
                    <FormField control={form.control} name="fbs" render={({ field }) => (
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} defaultValue={String(field.value)}>
                          <FormControl>
                            <SelectTrigger className="rounded-lg" data-testid="select-fbs"><SelectValue /></SelectTrigger>
                          </FormControl>
                          <SelectContent>
                    ...
                    <FormField control={form.control} name="restecg" render={({ field }) => (
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} defaultValue={String(field.value)}>
                          <FormControl>
                            <SelectTrigger className="rounded-lg" data-testid="select-restecg"><SelectValue /></SelectTrigger>
                          </FormControl>
                          <SelectContent>
                    ...
                    <FormField control={form.control} name="thalachh" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input type="number" className="rounded-lg" data-testid="input-thalachh" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    ...
                    <FormField control={form.control} name="exng" render={({ field }) => (
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} defaultValue={String(field.value)}>
                          <FormControl>
                            <SelectTrigger className="rounded-lg" data-testid="select-exng"><SelectValue /></SelectTrigger>
                          </FormControl>
                          <SelectContent>
                            <SelectItem value="0">No</SelectItem>
                            <SelectItem value="1">Yes</SelectItem>
                    ...
                    <FormField control={form.control} name="oldpeak" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input type="number" step="0.1" className="rounded-lg" data-testid="input-oldpeak" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    ...
                    <FormField control={form.control} name="slp" render={({ field }) => (
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} defaultValue={String(field.value)}>
                          <FormControl>
                            <SelectTrigger className="rounded-lg" data-testid="select-slp"><SelectValue /></SelectTrigger>
                          </FormControl>
                          <SelectContent>
                    ...
                    <FormField control={form.control} name="caa" render={({ field }) => (
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} defaultValue={String(field.value)}>
                          <FormControl>
                            <SelectTrigger className="rounded-lg" data-testid="select-caa"><SelectValue /></SelectTrigger>
                          </FormControl>
                          <SelectContent>
                            {[0, 1, 2, 3, 4].map((v) => (
                    ...
                    <FormField control={form.control} name="thall" render={({ field }) => (
                      <FormItem className="col-span-1 sm:col-span-2">
                        ...
                        <Select onValueChange={field.onChange} defaultValue={String(field.value)}>
                          <FormControl>
                            <SelectTrigger className="rounded-lg" data-testid="select-thall"><SelectValue /></SelectTrigger>
                          </FormControl>
                          <SelectContent>
                            <SelectItem value="0">Normal</SelectItem>
                  ...
                  <Button
                    ...
                    className="w-full h-12 rounded-xl font-semibold text-base text-white shadow-md transition-all duration-200 hover:opacity-90 hover:-translate-y-0.5"
              ...
              <Card className={`rounded-2xl shadow-xl border-0 overflow-hidden`}>
                <div className={`px-7 pt-7 pb-5 ${isHighRisk ? "gradient-danger" : "gradient-safe"}`}>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-sm font-medium text-white/80 uppercase tracking-widest">Diagnostic Result</span>
                  </div>
                  ...
                  <CardContent className="flex flex-col gap-3">
                    {topFeatures.map((f: any) => (
                      <FeatureBar
                        key={f.feature}
                        name={f.feature}
                        value={Math.abs(f.coefficient)}
                        max={maxCoef}
                      />
                    ))}
                    <p className="text-xs text-muted-foreground mt-2 italic">
                      Bar lengths represent the absolute coefficient weights from the Logistic Regression model.
                    </p>
                  </CardContent>
                </Card>
              )}
